...
func main() {
	...
	result, err := RunPlan(*planPath, *safetyRate)
	if err != nil {
...
Pass the path of your generated plan.yaml to this tool for precise duration and cost estimation.`,
	}, func(ctx context.Context, req *mcp.CallToolRequest, input CalculatePlanInput) (*mcp.CallToolResult, CalculatePlanOutput, error) {
		result, err := RunPlan(input.PlanPath, 1.8)
		if err != nil {
	...
	s.AddResource(&mcp.Resource{
		URI:      "ttp://spec.md",
		Name:     "Token-Time Planer Specification",
